...
- [x] **Linked**. If you fix a specific issue, add it to the title and its description to the body.
...
- [x] **Discussion**. If you implement a feature that requires a new design for the app, be ready to receive and follow comments or edit suggestions.
