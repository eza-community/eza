...
const ENV_VARS_TO_KEEP_STARTS_WITH: &[&str] = &[
    "RUST", // for RUST_BACKTRACE
    "TERM", // for TERM, to have color in trycmd output
    "TRYCMD",
];
const ENV_VARS_TO_SET: &[(&str, &str)] = &[
    ("LANG", "en_US.UTF-8"),
    ("EZA_CONFIG_DIR", "/dev/null"), // to not use the user’s config
];
