...
pub fn get_command() -> clap::Command {
    clap::Command::new(clap::crate_name!())
        ...
        .arg(arg!(-b --binary "show file sizes with binary prefixes").overrides_with("bytes"))
        .arg(arg!(-B --bytes "show file sizes in bytes, without any prefixes").overrides_with("binary"))
