...
pub static COLOR:  Arg = Arg { short: None, long: "color",  takes_value: TakesValue::Necessary(Some(COLORS)) };
pub static COLOUR: Arg = Arg { short: None, long: "colour", takes_value: TakesValue::Necessary(Some(COLORS)) };
const COLORS: &[&str] = &["always", "auto", "never"];
...
pub static ALL_ARGS: Args = Args(&[
    ...
    &COLOR, &COLOUR, &COLOUR_SCALE, &COLOR_SCALE, &WIDTH,
