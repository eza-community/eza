...
pub static HIDE_EXTENDED:     Arg = Arg { short: None,       long: "no-extended",        takes_value: TakesValue::Forbidden };
...
pub static ALL_ARGS: Args = Args(&[
    ...
    &EXTENDED, NO_EXTENDED, &OCTAL, &SECURITY_CONTEXT, &STDIN, &FILE_FLAGS
]);
