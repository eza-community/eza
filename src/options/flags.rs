...
pub static CACHEDIR_IGNORE:  Arg = Arg { short: None, long: "cachedir-ignore",   takes_value: TakesValue::Forbidden };
...
pub static ALL_ARGS: Args = Args(&[
    ...
    &IGNORE_GLOB, &GIT_IGNORE, &CACHEDIR_IGNORE, &ONLY_DIRS, &ONLY_FILES,
